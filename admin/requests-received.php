...
{               ?>
                 ...
                 <td><?php  echo htmlentities($row->Message);?> 
                                            ...
                                            <td>
                                              <?php  echo htmlentities($row->RequestDate);?>  
                                            </td>
                                        </tr>
                                    <?php $cnt=$cnt+1;}}?>
